...
| **Pane** | A *leaf* sash. Holds a single glass. | `<bw-pane sash-id="…">` |
| **Muntin** | An *internal* (parent) sash: the draggable divider used to resize the two children. | `<bw-muntin sash-id="…">` |
